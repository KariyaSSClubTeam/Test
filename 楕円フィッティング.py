...
#画像の読み込み
img = cv2.imread("C:\\Users\\tuzuk\\Desktop\\volto_copy.png")
...
cv2.imwrite("C:\\Users\\tuzuk\\Desktop\\volto_out2.png", th)
...
cv2.imwrite("C:\\Users\\tuzuk\\Desktop\\volto_out1.png",img)
